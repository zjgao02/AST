...
def propose_strategy():
    """OpenEvolve edits the CD25-selective scFv topology/region blueprint only."""
        ...
        "design_regions": [
            {
                ...
                "role": "dominant CDR surface for CD25 epitope contacts while avoiding IL2RB/CD122",
                "position": 1,
...
_LOCKED_RUNTIME_DEFAULTS: Dict[str, Any] = {
    ...
    "mcts_output_dir": "artifacts/cd25_scfv_selectivity/inner_loop_runs/latest",
    "mcts_save_tree": True,
...
def _current_case_kwargs():
    return current_case_kwargs("cd25_scfv_selectivity")
