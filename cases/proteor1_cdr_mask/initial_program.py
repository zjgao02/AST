...
def propose_strategy():
    """OpenEvolve edits the ProteoR1-style masked CDR scFv topology/region blueprint only."""
        ...
        "design_regions": [
            {
                ...
                "role": "dominant CDR surface for 8r9y antigen hotspot epitope contacts while avoiding non-hotspot antigen surface",
                "position": 1,
...
_LOCKED_RUNTIME_DEFAULTS: Dict[str, Any] = {
    ...
    "mcts_output_dir": "artifacts/proteor1_cdr_mask/inner_loop_runs/latest",
    "mcts_save_tree": True,
...
def _current_case_kwargs():
    return current_case_kwargs("proteor1_cdr_mask")
