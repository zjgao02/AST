...
def propose_strategy():
    """OpenEvolve edits the PD-L1-selective scFv topology/region blueprint only."""
        ...
        "design_regions": [
            {
                ...
                "role": "dominant CDR surface for PD-L1 epitope contacts while avoiding PD-L2/PD-1",
                "position": 1,
...
_LOCKED_RUNTIME_DEFAULTS: Dict[str, Any] = {
    ...
    "mcts_output_dir": "artifacts/pdl1_scfv_selectivity/inner_loop_runs/latest",
    "mcts_save_tree": True,
...
def _current_case_kwargs():
    return current_case_kwargs("pdl1_scfv_selectivity")
